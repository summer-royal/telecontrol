...
def main():
    ...
    # get data from file
    restored_data = DataFilter.read_file('/content/drive/My Drive/Training Data/EEG_clench_summer_COND-0_TRIAL-48_20211124-150009.csv')
    ...
    for channel in eeg_channels:
      DataFilter.perform_bandpass(restored_data[channel], BoardShim.get_sampling_rate(board_id), 50.0, 50.0, 4,
